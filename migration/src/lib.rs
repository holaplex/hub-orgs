...
mod m20230228_235425_delete_webhooks_table;
mod m20230228_235431_delete_webhook_projects_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20230228_235425_delete_webhooks_table::Migration),
            Box::new(m20230228_235431_delete_webhook_projects_table::Migration),
        ]
    }
}
